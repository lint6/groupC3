...
for z in range(6):
    ...
    # plt.plot(variable1, variable2, color = 'blue')
    k=0
...
# print(FormattedData[8])
#
# with open("file.txt", "w") as output:
#     output.write(str(FormattedData[0]))
#     output.write(str())
#     output.write(str(FormattedData[8]))
#
# np.savetxt('fileTime.txt', FormattedData[0])
# np.savetxt('fileValue.txt', FormattedData[8])
